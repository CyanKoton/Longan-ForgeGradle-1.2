...
public class Mirrorstation {
    ...
    // maven
    protected String longanMavenUrl  = "https://longan.beanflame.cn/maven";
    ...
    */
    ...
    // LONGAN_MAVEN_URL ok
    public String getLonganMavenUrl() { return longanMavenUrl; }
    public void setLonganMavenUrl(String longanMavenUrl) { this.longanMavenUrl = longanMavenUrl; }
